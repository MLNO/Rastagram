...
import ir.besteveryeverapp.telegram.BuildVars;
...
import ir.besteveryeverapp.ui.Cells.TextInfoCell;
...
import ir.besteveryeverapp.ui.Components.NumberPicker;
...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    builder.setMessage(LocaleController.getString("AreYouSureLogout", ir.besteveryeverapp.telegram.R.string.AreYouSureLogout));
        ...
        ActionBarMenuItem item = menu.addItem(0, ir.besteveryeverapp.telegram.R.drawable.ic_ab_other);
        item.addSubItem(edit_name, LocaleController.getString("EditName", ir.besteveryeverapp.telegram.R.string.EditName), 0);
        item.addSubItem(logout, LocaleController.getString("LogOut", ir.besteveryeverapp.telegram.R.string.LogOut), 0);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                if (i == textSizeRow) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setTitle(LocaleController.getString("TextSize", ir.besteveryeverapp.telegram.R.string.TextSize));
                    final NumberPicker numberPicker = new NumberPicker(getParentActivity());
                    numberPicker.setMinValue(12);
                    numberPicker.setMaxValue(30);
                    numberPicker.setValue(MessagesController.getInstance().fontSize);
                    builder.setView(numberPicker);
                    builder.setNegativeButton(LocaleController.getString("Done", ir.besteveryeverapp.telegram.R.string.Done), new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    message.setText(Html.fromHtml(LocaleController.getString("AskAQuestionInfo", ir.besteveryeverapp.telegram.R.string.AskAQuestionInfo)));
                    ...
                    builder.setPositiveButton(LocaleController.getString("AskButton", ir.besteveryeverapp.telegram.R.string.AskButton), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            performAskAQuestion();
                        }
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("AreYouSure", ir.besteveryeverapp.telegram.R.string.AreYouSure));
                    builder.setTitle(LocaleController.getString("AppName", ir.besteveryeverapp.telegram.R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("OK", ir.besteveryeverapp.telegram.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    Browser.openUrl(getParentActivity(), LocaleController.getString("TelegramFaqUrl", ir.besteveryeverapp.telegram.R.string.TelegramFaqUrl));
                } else if (i == privacyPolicyRow) {
                    Browser.openUrl(getParentActivity(), LocaleController.getString("PrivacyPolicyUrl", ir.besteveryeverapp.telegram.R.string.PrivacyPolicyUrl));
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setTitle(LocaleController.getString("SortBy", ir.besteveryeverapp.telegram.R.string.SortBy));
                    builder.setItems(new CharSequence[]{
                            LocaleController.getString("Default", ir.besteveryeverapp.telegram.R.string.Default),
                            LocaleController.getString("SortFirstName", ir.besteveryeverapp.telegram.R.string.SortFirstName),
                            LocaleController.getString("SortLastName", ir.besteveryeverapp.telegram.R.string.SortLastName)
                    ...
                    for (int a = 0; a < 6; a++) {
                        ...
                        if (a == 0) {
                            ...
                            name = LocaleController.getString("AttachPhoto", ir.besteveryeverapp.telegram.R.string.AttachPhoto);
                        } else if (a == 1) {
                            maskValues[a] = (mask & MediaController.AUTODOWNLOAD_MASK_AUDIO) != 0;
                            name = LocaleController.getString("AttachAudio", ir.besteveryeverapp.telegram.R.string.AttachAudio);
                        } else if (a == 2) {
                            maskValues[a] = (mask & MediaController.AUTODOWNLOAD_MASK_VIDEO) != 0;
                            name = LocaleController.getString("AttachVideo", ir.besteveryeverapp.telegram.R.string.AttachVideo);
                        } else if (a == 3) {
                            maskValues[a] = (mask & MediaController.AUTODOWNLOAD_MASK_DOCUMENT) != 0;
                            name = LocaleController.getString("AttachDocument", ir.besteveryeverapp.telegram.R.string.AttachDocument);
                        } else if (a == 4) {
                            maskValues[a] = (mask & MediaController.AUTODOWNLOAD_MASK_MUSIC) != 0;
                            name = LocaleController.getString("AttachMusic", ir.besteveryeverapp.telegram.R.string.AttachMusic);
                        } else if (a == 5) {
                            maskValues[a] = (mask & MediaController.AUTODOWNLOAD_MASK_GIF) != 0;
                            name = LocaleController.getString("AttachGif", ir.besteveryeverapp.telegram.R.string.AttachGif);
                        }
                        CheckBoxCell checkBoxCell = new CheckBoxCell(getParentActivity());
                        checkBoxCell.setTag(a);
                        checkBoxCell.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.list_selector);
                    ...
                    cell.setTextAndIcon(LocaleController.getString("Save", ir.besteveryeverapp.telegram.R.string.Save).toUpperCase(), 0);
    ...
    private void updateUserData() {
        ...
        if (avatarImage != null) {
            ...
            onlineTextView.setText(LocaleController.getString("Online", ir.besteveryeverapp.telegram.R.string.Online));
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == textSizeRow) {
                    ...
                    textCell.setTextAndValue(LocaleController.getString("TextSize", ir.besteveryeverapp.telegram.R.string.TextSize), String.format("%d", size), true);
                } else if (i == languageRow) {
                    textCell.setTextAndValue(LocaleController.getString("Language", ir.besteveryeverapp.telegram.R.string.Language), LocaleController.getCurrentLanguageName(), true);
                } else if (i == contactsSortRow) {
                    String value;
                    SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE);
                    int sort = preferences.getInt("sortContactsBy", 0);
                    if (sort == 0) {
                        value = LocaleController.getString("Default", ir.besteveryeverapp.telegram.R.string.Default);
                    } else if (sort == 1) {
                        value = LocaleController.getString("FirstName", ir.besteveryeverapp.telegram.R.string.SortFirstName);
                    } else {
                        value = LocaleController.getString("LastName", ir.besteveryeverapp.telegram.R.string.SortLastName);
                    }
                    textCell.setTextAndValue(LocaleController.getString("SortBy", ir.besteveryeverapp.telegram.R.string.SortBy), value, true);
                } else if (i == notificationRow) {
                    textCell.setText(LocaleController.getString("NotificationsAndSounds", ir.besteveryeverapp.telegram.R.string.NotificationsAndSounds), true);
                } else if (i == backgroundRow) {
                    textCell.setText(LocaleController.getString("ChatBackground", ir.besteveryeverapp.telegram.R.string.ChatBackground), true);
                } else if (i == sendLogsRow) {
                    textCell.setText("Send Logs", true);
                } else if (i == clearLogsRow) {
                    textCell.setText("Clear Logs", true);
                } else if (i == askQuestionRow) {
                    textCell.setText(LocaleController.getString("AskAQuestion", ir.besteveryeverapp.telegram.R.string.AskAQuestion), true);
                } else if (i == privacyRow) {
                    textCell.setText(LocaleController.getString("PrivacySettings", ir.besteveryeverapp.telegram.R.string.PrivacySettings), true);
                } else if (i == switchBackendButtonRow) {
                    textCell.setText("Switch Backend", true);
                } else if (i == telegramFaqRow) {
                    textCell.setText(LocaleController.getString("TelegramFAQ", ir.besteveryeverapp.telegram.R.string.TelegramFaq), true);
                } else if (i == contactsReimportRow) {
                    textCell.setText(LocaleController.getString("ImportContacts", ir.besteveryeverapp.telegram.R.string.ImportContacts), true);
                } else if (i == stickersRow) {
                    textCell.setText(LocaleController.getString("Stickers", ir.besteveryeverapp.telegram.R.string.Stickers), true);
                } else if (i == cacheRow) {
                    textCell.setText(LocaleController.getString("CacheSettings", ir.besteveryeverapp.telegram.R.string.CacheSettings), true);
                } else if (i == privacyPolicyRow) {
                    textCell.setText(LocaleController.getString("PrivacyPolicy", ir.besteveryeverapp.telegram.R.string.PrivacyPolicy), true);
                }
            } else if (type == 3) {
                if (view == null) {
                ...
                if (i == enableAnimationsRow) {
                    textCell.setTextAndCheck(LocaleController.getString("EnableAnimations", ir.besteveryeverapp.telegram.R.string.EnableAnimations), preferences.getBoolean("view_animations", true), false);
                } else if (i == sendByEnterRow) {
                    textCell.setTextAndCheck(LocaleController.getString("SendByEnter", ir.besteveryeverapp.telegram.R.string.SendByEnter), preferences.getBoolean("send_by_enter", false), false);
                } else if (i == saveToGalleryRow) {
                    textCell.setTextAndCheck(LocaleController.getString("SaveToGallerySettings", ir.besteveryeverapp.telegram.R.string.SaveToGallerySettings), MediaController.getInstance().canSaveToGallery(), false);
                } else if (i == autoplayGifsRow) {
                    textCell.setTextAndCheck(LocaleController.getString("AutoplayGifs", ir.besteveryeverapp.telegram.R.string.AutoplayGifs), MediaController.getInstance().canAutoplayGifs(), true);
                } else if (i == raiseToSpeakRow) {
                    textCell.setTextAndCheck(LocaleController.getString("RaiseToSpeak", ir.besteveryeverapp.telegram.R.string.RaiseToSpeak), MediaController.getInstance().canRaiseToSpeak(), true);
                } else if (i == customTabsRow) {
                    textCell.setTextAndValueAndCheck(LocaleController.getString("ChromeCustomTabs", ir.besteveryeverapp.telegram.R.string.ChromeCustomTabs), LocaleController.getString("ChromeCustomTabsInfo", ir.besteveryeverapp.telegram.R.string.ChromeCustomTabsInfo), MediaController.getInstance().canCustomTabs(), false, true);
                } else if (i == directShareRow) {
                    textCell.setTextAndValueAndCheck(LocaleController.getString("DirectShare", ir.besteveryeverapp.telegram.R.string.DirectShare), LocaleController.getString("DirectShareInfo", ir.besteveryeverapp.telegram.R.string.DirectShareInfo), MediaController.getInstance().canDirectShare(), false, true);
                }
            } else if (type == 4) {
                if (view == null) {
                ...
                if (i == settingsSectionRow2) {
                    ((HeaderCell) view).setText(LocaleController.getString("SETTINGS", ir.besteveryeverapp.telegram.R.string.SETTINGS));
                } else if (i == supportSectionRow2) {
                    ((HeaderCell) view).setText(LocaleController.getString("Support", ir.besteveryeverapp.telegram.R.string.Support));
                } else if (i == messagesSectionRow2) {
                    ((HeaderCell) view).setText(LocaleController.getString("MessagesSettings", ir.besteveryeverapp.telegram.R.string.MessagesSettings));
                } else if (i == mediaDownloadSection2) {
                    ((HeaderCell) view).setText(LocaleController.getString("AutomaticMediaDownload", ir.besteveryeverapp.telegram.R.string.AutomaticMediaDownload));
                } else if (i == numberSectionRow) {
                    ((HeaderCell) view).setText(LocaleController.getString("Info", ir.besteveryeverapp.telegram.R.string.Info));
                }
            } else if (type == 5) {
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(LocaleController.getString("About_this_app", ir.besteveryeverapp.telegram.R.string.About_this_app));
                ...
                if (i == mobileDownloadRow || i == wifiDownloadRow || i == roamingDownloadRow) {
                    ...
                    SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE);
                    if (i == mobileDownloadRow) {
                        value = LocaleController.getString("WhenUsingMobileData", ir.besteveryeverapp.telegram.R.string.WhenUsingMobileData);
                        mask = MediaController.getInstance().mobileDataDownloadMask;
                    } else if (i == wifiDownloadRow) {
                        value = LocaleController.getString("WhenConnectedOnWiFi", ir.besteveryeverapp.telegram.R.string.WhenConnectedOnWiFi);
                        mask = MediaController.getInstance().wifiDownloadMask;
                    } else {
                        value = LocaleController.getString("WhenRoaming", ir.besteveryeverapp.telegram.R.string.WhenRoaming);
                        mask = MediaController.getInstance().roamingDownloadMask;
                    }
                    String text = "";
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_PHOTO) != 0) {
                        text += LocaleController.getString("AttachPhoto", ir.besteveryeverapp.telegram.R.string.AttachPhoto);
                    }
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_AUDIO) != 0) {
                        if (text.length() != 0) {
                            text += ", ";
                        }
                        text += LocaleController.getString("AttachAudio", ir.besteveryeverapp.telegram.R.string.AttachAudio);
                    }
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_VIDEO) != 0) {
                        if (text.length() != 0) {
                            text += ", ";
                        }
                        text += LocaleController.getString("AttachVideo", ir.besteveryeverapp.telegram.R.string.AttachVideo);
                    }
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_DOCUMENT) != 0) {
                        if (text.length() != 0) {
                            text += ", ";
                        }
                        text += LocaleController.getString("AttachDocument", ir.besteveryeverapp.telegram.R.string.AttachDocument);
                    }
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_MUSIC) != 0) {
                        if (text.length() != 0) {
                            text += ", ";
                        }
                        text += LocaleController.getString("AttachMusic", ir.besteveryeverapp.telegram.R.string.AttachMusic);
                    }
                    if ((mask & MediaController.AUTODOWNLOAD_MASK_GIF) != 0) {
                        if (text.length() != 0) {
                            text += ", ";
                        }
                        text += LocaleController.getString("AttachGif", ir.besteveryeverapp.telegram.R.string.AttachGif);
                    }
                    if (text.length() == 0) {
                        text = LocaleController.getString("NoMediaAutoDownload", ir.besteveryeverapp.telegram.R.string.NoMediaAutoDownload);
                    }
                    ...
                    if (user != null && user.phone != null && user.phone.length() != 0) {
                        ...
                        value = LocaleController.getString("NumberUnknown", ir.besteveryeverapp.telegram.R.string.NumberUnknown);
                    }
                    textCell.setTextAndValue(value, LocaleController.getString("Phone", ir.besteveryeverapp.telegram.R.string.Phone), true);
                } else if (i == usernameRow) {
                    TLRPC.User user = UserConfig.getCurrentUser();
                    String value;
                    if (user != null && user.username != null && user.username.length() != 0) {
                        ...
                        value = LocaleController.getString("UsernameEmpty", ir.besteveryeverapp.telegram.R.string.UsernameEmpty);
                    }
                    textCell.setTextAndValue(value, LocaleController.getString("Username", ir.besteveryeverapp.telegram.R.string.Username), false);
                }
            }
            return view;
        }
