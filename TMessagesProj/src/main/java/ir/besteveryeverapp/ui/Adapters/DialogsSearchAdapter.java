...
import ir.besteveryeverapp.ui.Cells.HashtagSearchCell;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                ...
                view.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.list_selector);
                break;
            case 1:
        ...
        switch (holder.getItemViewType()) {
            ...
            case 1: {
                ...
                if (isRecentSearchDisplayed()) {
                    int offset = (!SearchQuery.hints.isEmpty() ? 2 : 0);
                    if (position < offset) {
                        cell.setText(LocaleController.getString("ChatHints", ir.besteveryeverapp.telegram.R.string.ChatHints).toUpperCase());
                    } else {
                        cell.setText(LocaleController.getString("Recent", ir.besteveryeverapp.telegram.R.string.Recent).toUpperCase());
                    }
                } else if (!searchResultHashtags.isEmpty()) {
                    cell.setText(LocaleController.getString("Hashtags", ir.besteveryeverapp.telegram.R.string.Hashtags).toUpperCase());
                } else if (!globalSearch.isEmpty() && position == searchResult.size()) {
                    cell.setText(LocaleController.getString("GlobalSearch", ir.besteveryeverapp.telegram.R.string.GlobalSearch));
                } else {
                    cell.setText(LocaleController.getString("SearchMessages", ir.besteveryeverapp.telegram.R.string.SearchMessages));
                }
                break;
            }
            case 2: {
