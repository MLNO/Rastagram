...
public class about extends BaseFragment implements View.OnClickListener {
    ...
    switch (v.getId()){
        case R.id.about_3:
            Intent intent = new Intent(Intent.ACTION_VIEW , Uri.parse("bazaar://collection?slug=by_author&aid=milano"));
        ...
        case R.id.about_4:
            ...
            i.putExtra(Intent.EXTRA_EMAIL  , new String[]{"milano_apps@outlook.com"});
