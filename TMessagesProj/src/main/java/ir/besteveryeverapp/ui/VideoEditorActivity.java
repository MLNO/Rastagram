...
import ir.besteveryeverapp.ui.Components.VideoSeekBarView;
import ir.besteveryeverapp.ui.Components.VideoTimelineView;
...
public class VideoEditorActivity extends BaseFragment implements TextureView.SurfaceTextureListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("EditVideo", ir.besteveryeverapp.telegram.R.string.EditVideo));
        ...
        menu.addItemWithWidth(1, ir.besteveryeverapp.telegram.R.drawable.ic_done, AndroidUtilities.dp(56));

        fragmentView = getParentActivity().getLayoutInflater().inflate(ir.besteveryeverapp.telegram.R.layout.video_editor_layout, null, false);
        originalSizeTextView = (TextView) fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.original_size);
        editedSizeTextView = (TextView) fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.edited_size);
        videoContainerView = fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.video_container);
        textContainerView = fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.info_container);
        controlView = fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.control_layout);
        compressVideo = (CheckBox) fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.compress_video);
        compressVideo.setText(LocaleController.getString("CompressVideo", ir.besteveryeverapp.telegram.R.string.CompressVideo));
        ...
        TextView titleTextView = (TextView) fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.original_title);
        titleTextView.setText(LocaleController.getString("OriginalVideo", ir.besteveryeverapp.telegram.R.string.OriginalVideo));
        titleTextView = (TextView) fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.edited_title);
        titleTextView.setText(LocaleController.getString("EditedVideo", ir.besteveryeverapp.telegram.R.string.EditedVideo));

        videoTimelineView = (VideoTimelineView) fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.video_timeline_view);
            ...
            public void onLeftProgressChanged(float progress) {
                ...
                try {
                    if (videoPlayer.isPlaying()) {
                        videoPlayer.pause();
                        playButton.setImageResource(ir.besteveryeverapp.telegram.R.drawable.video_play);
                    }
        ...
        videoSeekBarView = (VideoSeekBarView) fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.video_seekbar);
        ...
        playButton = (ImageView) fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.play_button);
        ...
        textureView = (TextureView) fragmentView.findViewById(ir.besteveryeverapp.telegram.R.id.video_view);
