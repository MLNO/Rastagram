...
import ir.besteveryeverapp.ui.Cells.SessionCell;
...
public class SessionsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("SessionsTitle", ir.besteveryeverapp.telegram.R.string.SessionsTitle));
        ...
        emptyLayout.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.greydivider_bottom);
        ...
        imageView.setImageResource(ir.besteveryeverapp.telegram.R.drawable.devices);
        ...
        textView.setText(LocaleController.getString("NoOtherSessions", ir.besteveryeverapp.telegram.R.string.NoOtherSessions));
        ...
        textView.setText(LocaleController.getString("NoOtherSessionsInfo", ir.besteveryeverapp.telegram.R.string.NoOtherSessionsInfo));
        emptyLayout.addView(textView);
        layoutParams2 = (LinearLayout.LayoutParams) textView.getLayoutParams();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                if (i == terminateAllSessionsRow) {
                    ...
                    builder.setMessage(LocaleController.getString("AreYouSureSessions", ir.besteveryeverapp.telegram.R.string.AreYouSureSessions));
                                    ...
                                    AndroidUtilities.runOnUIThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            if (error == null && response instanceof TLRPC.TL_boolTrue) {
                                                Toast toast = Toast.makeText(getParentActivity(), LocaleController.getString("TerminateAllSessions", ir.besteveryeverapp.telegram.R.string.TerminateAllSessions), Toast.LENGTH_SHORT);
                                                toast.show();
                                            } else {
                                                Toast toast = Toast.makeText(getParentActivity(), LocaleController.getString("UnknownError", ir.besteveryeverapp.telegram.R.string.UnknownError), Toast.LENGTH_SHORT);
                                                toast.show();
                                            }
                                            finishFragment();
                                        }
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("TerminateSessionQuestion", ir.besteveryeverapp.telegram.R.string.TerminateSessionQuestion));
                    builder.setTitle(LocaleController.getString("AppName", ir.besteveryeverapp.telegram.R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("OK", ir.besteveryeverapp.telegram.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == terminateAllSessionsRow) {
                    ...
                    textCell.setText(LocaleController.getString("TerminateAllSessions", ir.besteveryeverapp.telegram.R.string.TerminateAllSessions), false);
                }
            } else if (type == 1) {
                if (view == null) {
                ...
                if (i == terminateAllSessionsDetailRow) {
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("ClearOtherSessionsHelp", ir.besteveryeverapp.telegram.R.string.ClearOtherSessionsHelp));
                    view.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.greydivider);
                } else if (i == otherSessionsTerminateDetail) {
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("TerminateSessionInfo", ir.besteveryeverapp.telegram.R.string.TerminateSessionInfo));
                ...
                if (i == currentSessionSectionRow) {
                    ((HeaderCell) view).setText(LocaleController.getString("CurrentSession", ir.besteveryeverapp.telegram.R.string.CurrentSession));
                } else if (i == otherSessionsSectionRow) {
                    ((HeaderCell) view).setText(LocaleController.getString("OtherSessions", ir.besteveryeverapp.telegram.R.string.OtherSessions));
                }
            } else if (type == 3) {
