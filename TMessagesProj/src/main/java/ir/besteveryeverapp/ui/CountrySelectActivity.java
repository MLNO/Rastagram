...
import ir.besteveryeverapp.ui.Adapters.CountryAdapter;
import ir.besteveryeverapp.ui.Adapters.CountryAdapter.Country;
import ir.besteveryeverapp.ui.Adapters.CountrySearchAdapter;
import ir.besteveryeverapp.ui.Components.LayoutHelper;
import ir.besteveryeverapp.ui.Components.LetterSectionsListView;
...
public class CountrySelectActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("ChooseCountry", ir.besteveryeverapp.telegram.R.string.ChooseCountry));
        ...
        ActionBarMenuItem item = menu.addItem(0, ir.besteveryeverapp.telegram.R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
            ...
            public void onSearchCollapse() {
                ...
                emptyTextView.setText(LocaleController.getString("ChooseCountry", ir.besteveryeverapp.telegram.R.string.ChooseCountry));
            }
