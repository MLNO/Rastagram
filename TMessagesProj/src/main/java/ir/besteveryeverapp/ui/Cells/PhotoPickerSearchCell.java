...
public class PhotoPickerSearchCell extends LinearLayout {
    ...
    private class SearchButton extends FrameLayout {
        ...
        public SearchButton(Context context) {
            ...
            selector.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.list_selector);
    ...
    public PhotoPickerSearchCell(Context context, boolean allowGifs) {
        ...
        searchButton.textView1.setText(LocaleController.getString("SearchImages", ir.besteveryeverapp.telegram.R.string.SearchImages));
        searchButton.textView2.setText(LocaleController.getString("SearchImagesInfo", ir.besteveryeverapp.telegram.R.string.SearchImagesInfo));
        searchButton.imageView.setImageResource(ir.besteveryeverapp.telegram.R.drawable.search_web);
        ...
        searchButton.textView1.setText(LocaleController.getString("SearchGifs", ir.besteveryeverapp.telegram.R.string.SearchGifs));
        searchButton.textView2.setText("GIPHY");
        searchButton.imageView.setImageResource(ir.besteveryeverapp.telegram.R.drawable.search_gif);
        addView(searchButton);
