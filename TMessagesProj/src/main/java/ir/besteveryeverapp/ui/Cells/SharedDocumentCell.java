...
import ir.besteveryeverapp.ui.Components.LineProgressView;
...
public class SharedDocumentCell extends FrameLayout implements MediaController.FileDownloadProgressListener {
    ...
    private int icons[] = {
            ir.besteveryeverapp.telegram.R.drawable.media_doc_blue,
            ir.besteveryeverapp.telegram.R.drawable.media_doc_green,
            ir.besteveryeverapp.telegram.R.drawable.media_doc_red,
            ir.besteveryeverapp.telegram.R.drawable.media_doc_yellow
    };
    ...
    public SharedDocumentCell(Context context) {
        ...
        checkBox = new CheckBox(context, ir.besteveryeverapp.telegram.R.drawable.round_check2);
    ...
    public void setDocument(MessageObject messageObject, boolean divider) {
        ...
        if (messageObject != null && messageObject.getDocument() != null) {
            ...
            dateTextView.setText(String.format("%s, %s", AndroidUtilities.formatFileSize(messageObject.getDocument().size), LocaleController.formatString("formatDateAtTime", ir.besteveryeverapp.telegram.R.string.formatDateAtTime, LocaleController.getInstance().formatterYear.format(new Date(date)), LocaleController.getInstance().formatterDay.format(new Date(date)))));
        } else {
    ...
    public void updateFileExistIcon() {
        if (message != null && message.messageOwner.media != null) {
            ...
            if (fileName == null) {
                ...
                statusImageView.setImageResource(loading ? ir.besteveryeverapp.telegram.R.drawable.media_doc_pause : ir.besteveryeverapp.telegram.R.drawable.media_doc_load);
