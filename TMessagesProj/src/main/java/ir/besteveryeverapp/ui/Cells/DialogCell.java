...
public class DialogCell extends BaseCell {
    ...
    public DialogCell(Context context) {
        ...
        if (namePaint == null) {
           ...
           /// messagePrintingPaint.setColor(Theme.DIALOGS_PRINTING_TEXT_COLOR);
            ...
            lockDrawable = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.list_secret);
            checkDrawable = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.dialogs_check);
            halfCheckDrawable = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.dialogs_halfcheck);
            clockDrawable = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.msg_clock);
            errorDrawable = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.dialogs_warning);
            countDrawable = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.dialogs_badge);
            countDrawableGrey = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.dialogs_badge2);
            groupDrawable = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.list_group);
            broadcastDrawable = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.list_broadcast);
            muteDrawable = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.mute_grey);
            verifiedDrawable = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.check_list);
            botDrawable = getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.bot_list);
        }
        //:ramin
        ...
        setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.list_selector);
    ...
    public void buildLayout() {
        ...
        if (printingString != null) {
            ...
            if (draftMessage != null) {
                ...
                if (TextUtils.isEmpty(draftMessage.message)) {
                    String draftString = LocaleController.getString("Draft", ir.besteveryeverapp.telegram.R.string.Draft);
                ...
                if (message == null) {
                    if (encryptedChat != null) {
                        ...
                        if (encryptedChat instanceof TLRPC.TL_encryptedChatRequested) {
                            messageString = LocaleController.getString("EncryptionProcessing", ir.besteveryeverapp.telegram.R.string.EncryptionProcessing);
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChatWaiting) {
                            if (user != null && user.first_name != null) {
                                messageString = LocaleController.formatString("AwaitingEncryption", ir.besteveryeverapp.telegram.R.string.AwaitingEncryption, user.first_name);
                            } else {
                                messageString = LocaleController.formatString("AwaitingEncryption", ir.besteveryeverapp.telegram.R.string.AwaitingEncryption, "");
                            }
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChatDiscarded) {
                            messageString = LocaleController.getString("EncryptionRejected", ir.besteveryeverapp.telegram.R.string.EncryptionRejected);
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChat) {
                            if (encryptedChat.admin_id == UserConfig.getClientUserId()) {
                                if (user != null && user.first_name != null) {
                                    messageString = LocaleController.formatString("EncryptedChatStartedOutgoing", ir.besteveryeverapp.telegram.R.string.EncryptedChatStartedOutgoing, user.first_name);
                                } else {
                                    messageString = LocaleController.formatString("EncryptedChatStartedOutgoing", ir.besteveryeverapp.telegram.R.string.EncryptedChatStartedOutgoing, "");
                                }
                            } else {
                                messageString = LocaleController.getString("EncryptedChatStartedIncoming", ir.besteveryeverapp.telegram.R.string.EncryptedChatStartedIncoming);
                            }
                        }
                    }
                } else {
                    ...
                    if (message.messageOwner instanceof TLRPC.TL_messageService) {
                        ...
                        if (chat != null && chat.id > 0 && fromChat == null) {
                            ...
                            if (message.isOutOwner()) {
                                name = LocaleController.getString("FromYou", ir.besteveryeverapp.telegram.R.string.FromYou);
        ...
        if (nameString.length() == 0) {
            nameString = LocaleController.getString("HiddenName", ir.besteveryeverapp.telegram.R.string.HiddenName);
        }
