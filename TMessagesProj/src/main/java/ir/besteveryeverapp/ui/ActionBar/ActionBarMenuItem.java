...
public class ActionBarMenuItem extends FrameLayout {
    ...
    public TextView addSubItem(int id, String text, int icon) {
        ...
        textView.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.list_selector);
    ...
    public void toggleSubMenu() {
        ...
        if (popupWindow == null) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                popupWindow.setAnimationStyle(ir.besteveryeverapp.telegram.R.style.PopupAnimation);
            }
    ...
    public ActionBarMenuItem setIsSearchField(boolean value) {
        ...
        if (value && searchContainer == null) {
            ...
            try {
                ...
                mCursorDrawableRes.set(searchField, ir.besteveryeverapp.telegram.R.drawable.search_carret);
            } catch (Exception e) {
                //nothing to do
            }
            ...
            clearButton.setImageResource(ir.besteveryeverapp.telegram.R.drawable.ic_close_white);
