...
import ir.besteveryeverapp.ui.Cells.WallpaperCell;
...
public class WallpapersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("ChatBackground", ir.besteveryeverapp.telegram.R.string.ChatBackground));
        ...
        progressViewBackground.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.system_loader);
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                if (position == 0) {
                    ...
                    CharSequence[] items = new CharSequence[]{LocaleController.getString("FromCamera", ir.besteveryeverapp.telegram.R.string.FromCamera), LocaleController.getString("FromGalley", ir.besteveryeverapp.telegram.R.string.FromGalley), LocaleController.getString("Cancel", ir.besteveryeverapp.telegram.R.string.Cancel)};
    ...
    private void processSelectedBackground() {
        ...
        if (selectedBackground != -1 && selectedBackground != 1000001 && wallPaper != null && wallPaper instanceof TLRPC.TL_wallPaper) {
            ...
            if (selectedBackground == 1000001) {
                backgroundImage.setImageResource(ir.besteveryeverapp.telegram.R.drawable.background_hd);
                backgroundImage.setBackgroundColor(0);
                selectedColor = 0;
