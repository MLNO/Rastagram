...
import ir.besteveryeverapp.telegram.query.SharedMediaQuery;
...
import ir.besteveryeverapp.ui.Cells.AboutLinkCell;
import ir.besteveryeverapp.ui.Cells.DividerCell;
import ir.besteveryeverapp.ui.Cells.EmptyCell;
import ir.besteveryeverapp.ui.Cells.LoadingCell;
import ir.besteveryeverapp.ui.Cells.ShadowSectionCell;
import ir.besteveryeverapp.ui.Cells.TextCell;
import ir.besteveryeverapp.ui.Cells.TextDetailCell;
...
import ir.besteveryeverapp.ui.Components.IdenticonDrawable;
...
public class ProfileActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
            ...
            public void onItemClick(final int id) {
                ...
                if (id == -1) {
                    ...
                    if (!user.bot) {
                        ...
                        if (!userBlocked) {
                            builder.setMessage(LocaleController.getString("AreYouSureBlockContact", ir.besteveryeverapp.telegram.R.string.AreYouSureBlockContact));
                        } else {
                    ...
                    args.putString("selectAlertString", LocaleController.getString("SendContactTo", ir.besteveryeverapp.telegram.R.string.SendContactTo));
                    args.putString("selectAlertStringGroup", LocaleController.getString("SendContactToGroup", ir.besteveryeverapp.telegram.R.string.SendContactToGroup));
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("AreYouSureDeleteContact", ir.besteveryeverapp.telegram.R.string.AreYouSureDeleteContact));
                    builder.setTitle(LocaleController.getString("AppName", ir.besteveryeverapp.telegram.R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("OK", ir.besteveryeverapp.telegram.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    args.putString("addToGroupAlertString", LocaleController.formatString("AddToTheGroupTitle", ir.besteveryeverapp.telegram.R.string.AddToTheGroupTitle, UserObject.getUserName(user), "%1$s"));
                    DialogsActivity fragment = new DialogsActivity(args);
                    ...
                    try {
                        ...
                        startActivityForResult(Intent.createChooser(intent, LocaleController.getString("BotShare", ir.besteveryeverapp.telegram.R.string.BotShare)), 500);
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                ...
                if (position == sharedMediaRow) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("AreYouSureSecretChat", ir.besteveryeverapp.telegram.R.string.AreYouSureSecretChat));
                    builder.setTitle(LocaleController.getString("AppName", ir.besteveryeverapp.telegram.R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("OK", ir.besteveryeverapp.telegram.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    try {
                        ...
                        getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("BotShare", ir.besteveryeverapp.telegram.R.string.BotShare)), 500);
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("ConvertGroupAlert", ir.besteveryeverapp.telegram.R.string.ConvertGroupAlert));
                    builder.setTitle(LocaleController.getString("ConvertGroupAlertWarning", ir.besteveryeverapp.telegram.R.string.ConvertGroupAlertWarning));
                    builder.setPositiveButton(LocaleController.getString("OK", ir.besteveryeverapp.telegram.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            public boolean onItemClick(View view, int position) {
                if (position > emptyRowChat2 && position < membersEndRow) {
                    ...
                    if (currentChat.megagroup && currentChat.creator && allowSetAdmin) {
                        CharSequence[] items = new CharSequence[]{LocaleController.getString("SetAsAdmin", ir.besteveryeverapp.telegram.R.string.SetAsAdmin), LocaleController.getString("KickFromGroup", ir.besteveryeverapp.telegram.R.string.KickFromGroup)};
                        ...
                        CharSequence[] items = new CharSequence[]{chat_id > 0 ? LocaleController.getString("KickFromGroup", ir.besteveryeverapp.telegram.R.string.KickFromGroup) : LocaleController.getString("KickFromBroadcast", ir.besteveryeverapp.telegram.R.string.KickFromBroadcast)};
                        builder.setItems(items, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                if (i == 0) {
        ...
        try {
            shadowView.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.header_shadow);
        } catch (Throwable e) {
            FileLog.e("tmessages", e);
        }
        ...
        if (user_id != 0 || chat_id >= 0 && !ChatObject.isLeftFromChat(currentChat)) {
            ...
            try {
                writeButton.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.floating_user_states);
            } catch (Throwable e) {
                FileLog.e("tmessages", e);
            }
            writeButton.setScaleType(ImageView.ScaleType.CENTER);
            if (user_id != 0) {
                writeButton.setImageResource(ir.besteveryeverapp.telegram.R.drawable.floating_message);
                ...
                if (isChannel && !currentChat.creator && (!currentChat.megagroup || !currentChat.editor) || !isChannel && !currentChat.admin && !currentChat.creator && currentChat.admins_enabled) {
                    ...
                    writeButton.setImageResource(ir.besteveryeverapp.telegram.R.drawable.floating_camera);
                }
            }
    ...
    private boolean processOnClickOrPress(final int position) {
        if (position == usernameRow) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setItems(new CharSequence[]{LocaleController.getString("Copy", ir.besteveryeverapp.telegram.R.string.Copy)}, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    if (i == 0) {
                        try {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setItems(new CharSequence[]{LocaleController.getString("Call", ir.besteveryeverapp.telegram.R.string.Call), LocaleController.getString("Copy", ir.besteveryeverapp.telegram.R.string.Copy)}, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    if (i == 0) {
                        try {
    ...
    private void leaveChatPressed() {
        ...
        if (ChatObject.isChannel(chat_id) && !currentChat.megagroup) {
            builder.setMessage(ChatObject.isChannel(chat_id) ? LocaleController.getString("ChannelLeaveAlert", ir.besteveryeverapp.telegram.R.string.ChannelLeaveAlert) : LocaleController.getString("AreYouSureDeleteAndExit", ir.besteveryeverapp.telegram.R.string.AreYouSureDeleteAndExit));
        } else {
    ...
    private void openAddMember() {
        ...
        if (chat_id > 0) {
            ...
            args.putString("selectAlertString", LocaleController.getString("AddToTheGroup", ir.besteveryeverapp.telegram.R.string.AddToTheGroup));
        }
        ...
        if (playProfileAnimation && allowProfileAnimation) {
            ...
            if (menu.getItem(10) == null) {
                if (animatingItem == null) {
                    animatingItem = menu.addItem(10, ir.besteveryeverapp.telegram.R.drawable.ic_ab_other);
                }
            }
            if (isOpen) {
    ...
    private void updateProfileData() {
        ...
        if (user_id != 0) {
            ...
            if (user.id == 333000 || user.id == 777000) {
                newString2 = LocaleController.getString("ServiceNotifications", ir.besteveryeverapp.telegram.R.string.ServiceNotifications);
            } else if (user.bot) {
                newString2 = LocaleController.getString("Bot", ir.besteveryeverapp.telegram.R.string.Bot);
            } else {
            ...
            for (int a = 0; a < 2; a++) {
                ...
                int leftIcon = currentEncryptedChat != null ? ir.besteveryeverapp.telegram.R.drawable.ic_lock_header : 0;
                int rightIcon = 0;
                if (a == 0) {
                    rightIcon = MessagesController.getInstance().isDialogMuted(dialog_id != 0 ? dialog_id : (long) user_id) ? ir.besteveryeverapp.telegram.R.drawable.mute_fixed : 0;
                } else if (user.verified) {
                    rightIcon = ir.besteveryeverapp.telegram.R.drawable.check_profile_fixed;
                }
            ...
            if (ChatObject.isChannel(chat)) {
                if (info == null || !currentChat.megagroup && (info.participants_count == 0 || (currentChat.admin || info.can_view_participants))) {
                    if (currentChat.megagroup) {
                        newString = LocaleController.getString("Loading", ir.besteveryeverapp.telegram.R.string.Loading).toLowerCase();
                    } else {
                        if ((chat.flags & TLRPC.CHAT_FLAG_IS_PUBLIC) != 0) {
                            newString = LocaleController.getString("ChannelPublic", ir.besteveryeverapp.telegram.R.string.ChannelPublic).toLowerCase();
                        } else {
                            newString = LocaleController.getString("ChannelPrivate", ir.besteveryeverapp.telegram.R.string.ChannelPrivate).toLowerCase();
                        }
                    }
                } else {
            ...
            for (int a = 0; a < 2; a++) {
                ...
                if (a != 0) {
                    if (chat.verified) {
                        nameTextView[a].setRightDrawable(ir.besteveryeverapp.telegram.R.drawable.check_profile_fixed);
                    } else {
                        nameTextView[a].setRightDrawable(null);
                    }
                } else {
                    nameTextView[a].setRightDrawable(MessagesController.getInstance().isDialogMuted((long) -chat_id) ? ir.besteveryeverapp.telegram.R.drawable.mute_fixed : 0);
                }
    ...
    private void createActionBarMenu() {
        ...
        if (user_id != 0) {
            if (ContactsController.getInstance().contactsDict.get(user_id) == null) {
                ...
                item = menu.addItem(10, ir.besteveryeverapp.telegram.R.drawable.ic_ab_other);
                if (user.bot) {
                    if (!user.bot_nochats) {
                        item.addSubItem(invite_to_group, LocaleController.getString("BotInvite", ir.besteveryeverapp.telegram.R.string.BotInvite), 0);
                    }
                    item.addSubItem(share, LocaleController.getString("BotShare", ir.besteveryeverapp.telegram.R.string.BotShare), 0);
                }
                if (user.phone != null && user.phone.length() != 0) {
                    item.addSubItem(add_contact, LocaleController.getString("AddContact", ir.besteveryeverapp.telegram.R.string.AddContact), 0);
                    item.addSubItem(share_contact, LocaleController.getString("ShareContact", ir.besteveryeverapp.telegram.R.string.ShareContact), 0);
                    item.addSubItem(block_contact, !userBlocked ? LocaleController.getString("BlockContact", ir.besteveryeverapp.telegram.R.string.BlockContact) : LocaleController.getString("Unblock", ir.besteveryeverapp.telegram.R.string.Unblock), 0);
                } else {
                    if (user.bot) {
                        item.addSubItem(block_contact, !userBlocked ? LocaleController.getString("BotStop", ir.besteveryeverapp.telegram.R.string.BotStop) : LocaleController.getString("BotRestart", ir.besteveryeverapp.telegram.R.string.BotRestart), 0);
                    } else {
                        item.addSubItem(block_contact, !userBlocked ? LocaleController.getString("BlockContact", ir.besteveryeverapp.telegram.R.string.BlockContact) : LocaleController.getString("Unblock", ir.besteveryeverapp.telegram.R.string.Unblock), 0);
                    }
                }
                ...
                item.addSubItem(share_contact, LocaleController.getString("ShareContact", ir.besteveryeverapp.telegram.R.string.ShareContact), 0);
                item.addSubItem(block_contact, !userBlocked ? LocaleController.getString("BlockContact", ir.besteveryeverapp.telegram.R.string.BlockContact) : LocaleController.getString("Unblock", ir.besteveryeverapp.telegram.R.string.Unblock), 0);
                item.addSubItem(edit_contact, LocaleController.getString("EditContact", ir.besteveryeverapp.telegram.R.string.EditContact), 0);
                item.addSubItem(delete_contact, LocaleController.getString("DeleteContact", ir.besteveryeverapp.telegram.R.string.DeleteContact), 0);
            }
        } else if (chat_id != 0) {
            if (chat_id > 0) {
                TLRPC.Chat chat = MessagesController.getInstance().getChat(chat_id);
                ...
                if (ChatObject.isChannel(chat)) {
                    if (chat.creator || chat.megagroup && chat.editor) {
                        item = menu.addItem(10, ir.besteveryeverapp.telegram.R.drawable.ic_ab_other);
                        item.addSubItem(edit_channel, LocaleController.getString("ChannelEdit", ir.besteveryeverapp.telegram.R.string.ChannelEdit), 0);
                    }
                    if (!chat.creator && !chat.left && !chat.kicked && chat.megagroup) {
                        if (item == null) {
                            item = menu.addItem(10, ir.besteveryeverapp.telegram.R.drawable.ic_ab_other);
                        }
                        item.addSubItem(leave_group, LocaleController.getString("LeaveMegaMenu", ir.besteveryeverapp.telegram.R.string.LeaveMegaMenu), 0);
                    }
                } else {
                    item = menu.addItem(10, ir.besteveryeverapp.telegram.R.drawable.ic_ab_other);
                    if (chat.creator && chat_id > 0) {
                        item.addSubItem(set_admins, LocaleController.getString("SetAdmins", ir.besteveryeverapp.telegram.R.string.SetAdmins), 0);
                    }
                    if (!chat.admins_enabled || chat.creator || chat.admin) {
                        item.addSubItem(edit_name, LocaleController.getString("EditName", ir.besteveryeverapp.telegram.R.string.EditName), 0);
                    }
                    if (chat.creator && (info == null || info.participants.participants.size() > 1)) {
                        item.addSubItem(convert_to_supergroup, LocaleController.getString("ConvertGroupMenu", ir.besteveryeverapp.telegram.R.string.ConvertGroupMenu), 0);
                    }
                    item.addSubItem(leave_group, LocaleController.getString("DeleteAndExit", ir.besteveryeverapp.telegram.R.string.DeleteAndExit), 0);
                }
            } else {
                item = menu.addItem(10, ir.besteveryeverapp.telegram.R.drawable.ic_ab_other);
                item.addSubItem(edit_name, LocaleController.getString("EditName", ir.besteveryeverapp.telegram.R.string.EditName), 0);
        ...
        item.addSubItem(add_shortcut, LocaleController.getString("AddShortcut", ir.besteveryeverapp.telegram.R.string.AddShortcut), 0);
    }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case 6:
                    ...
                    cell.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.greydivider);
                    cell.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ConvertGroupInfo", ir.besteveryeverapp.telegram.R.string.ConvertGroupInfo, LocaleController.formatPluralString("Members", MessagesController.getInstance().maxMegagroupCount))));
                    break;
                case 7:
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    if (i == phoneRow) {
                        ...
                        if (user.phone != null && user.phone.length() != 0) {
                            ...
                            text = LocaleController.getString("NumberUnknown", ir.besteveryeverapp.telegram.R.string.NumberUnknown);
                        }
                        textDetailCell.setTextAndValueAndIcon(text, LocaleController.getString("PhoneMobile", ir.besteveryeverapp.telegram.R.string.PhoneMobile), ir.besteveryeverapp.telegram.R.drawable.phone_grey);
                        ...
                        textDetailCell.setTextAndValue(text, LocaleController.getString("Username", ir.besteveryeverapp.telegram.R.string.Username));
                ...
                case 3:
                    ...
                    if (i == sharedMediaRow) {
                        ...
                        textCell.setTextAndValue(LocaleController.getString("SharedMedia", ir.besteveryeverapp.telegram.R.string.SharedMedia), value);
                    } else if (i == settingsTimerRow) {
                        TLRPC.EncryptedChat encryptedChat = MessagesController.getInstance().getEncryptedChat((int)(dialog_id >> 32));
                        String value;
                        if (encryptedChat.ttl == 0) {
                            value = LocaleController.getString("ShortMessageLifetimeForever", ir.besteveryeverapp.telegram.R.string.ShortMessageLifetimeForever);
                        } else {
                            value = AndroidUtilities.formatTTLString(encryptedChat.ttl);
                        }
                        textCell.setTextAndValue(LocaleController.getString("MessageLifetime", ir.besteveryeverapp.telegram.R.string.MessageLifetime), value);
                    } else if (i == settingsNotificationsRow) {
                        textCell.setTextAndIcon(LocaleController.getString("NotificationsAndSounds", ir.besteveryeverapp.telegram.R.string.NotificationsAndSounds), ir.besteveryeverapp.telegram.R.drawable.profile_list);
                    } else if (i == startSecretChatRow) {
                        textCell.setText(LocaleController.getString("StartEncryptedChat", ir.besteveryeverapp.telegram.R.string.StartEncryptedChat));
                        textCell.setTextColor(0xff37a919);
                    } else if (i == settingsKeyRow) {
                        IdenticonDrawable identiconDrawable = new IdenticonDrawable();
                        TLRPC.EncryptedChat encryptedChat = MessagesController.getInstance().getEncryptedChat((int)(dialog_id >> 32));
                        identiconDrawable.setEncryptedChat(encryptedChat);
                        textCell.setTextAndValueDrawable(LocaleController.getString("EncryptionKey", ir.besteveryeverapp.telegram.R.string.EncryptionKey), identiconDrawable);
                    } else if (i == leaveChannelRow) {
                        textCell.setTextColor(0xffed3d39);
                        textCell.setText(LocaleController.getString("LeaveChannel", ir.besteveryeverapp.telegram.R.string.LeaveChannel));
                    } else if (i == convertRow) {
                        textCell.setText(LocaleController.getString("UpgradeGroup", ir.besteveryeverapp.telegram.R.string.UpgradeGroup));
                        textCell.setTextColor(0xff37a919);
                    } else if (i == membersRow) {
                        if (info != null) {
                            textCell.setTextAndValue(LocaleController.getString("ChannelMembers", ir.besteveryeverapp.telegram.R.string.ChannelMembers), String.format("%d", info.participants_count));
                        } else {
                            textCell.setText(LocaleController.getString("ChannelMembers", ir.besteveryeverapp.telegram.R.string.ChannelMembers));
                        }
                    } else if (i == managementRow) {
                        if (info != null) {
                            textCell.setTextAndValue(LocaleController.getString("ChannelAdministrators", ir.besteveryeverapp.telegram.R.string.ChannelAdministrators), String.format("%d", info.admins_count));
                        } else {
                            textCell.setText(LocaleController.getString("ChannelAdministrators", ir.besteveryeverapp.telegram.R.string.ChannelAdministrators));
                        }
                    } else if (i == blockedUsersRow) {
                        if (info != null) {
                            textCell.setTextAndValue(LocaleController.getString("ChannelBlockedUsers", ir.besteveryeverapp.telegram.R.string.ChannelBlockedUsers), String.format("%d", info.kicked_count));
                        } else {
                            textCell.setText(LocaleController.getString("ChannelBlockedUsers", ir.besteveryeverapp.telegram.R.string.ChannelBlockedUsers));
                        }
                    } else if (i == addMemberRow) {
                        if (chat_id > 0) {
                            textCell.setText(LocaleController.getString("AddMember", ir.besteveryeverapp.telegram.R.string.AddMember));
                        } else {
                            textCell.setText(LocaleController.getString("AddRecipient", ir.besteveryeverapp.telegram.R.string.AddRecipient));
                        }
                    }
                    break;
                case 4:
                    ...
                    if (part != null) {
                        ...
                        userCell.setData(MessagesController.getInstance().getUser(part.user_id), null, null, i == emptyRowChat2 + 1 ? ir.besteveryeverapp.telegram.R.drawable.menu_newgroup : 0);
                    }
                    break;
                case 8:
                    ...
                    if (i == userInfoRow) {
                        ...
                        aboutLinkCell.setTextAndIcon(about, ir.besteveryeverapp.telegram.R.drawable.bot_info);
                    } else if (i == channelInfoRow) {
                        String text = info.about;
                        while (text.contains("\n\n\n")) {
                            text = text.replace("\n\n\n", "\n\n");
                        }
                        aboutLinkCell.setTextAndIcon(text, ir.besteveryeverapp.telegram.R.drawable.bot_info);
                    }
                    break;
                default:
            ...
            if (checkBackground) {
                ...
                if (enabled) {
                    if (holder.itemView.getBackground() == null) {
                        holder.itemView.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.list_selector);
                    }
                } else {
                    if (holder.itemView.getBackground() != null) {
