...
public class ChangePhoneHelpActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        imageView.setImageResource(ir.besteveryeverapp.telegram.R.drawable.phone_change);
        ...
        try {
            textView.setText(AndroidUtilities.replaceTags(LocaleController.getString("PhoneNumberHelp", ir.besteveryeverapp.telegram.R.string.PhoneNumberHelp)));
        } catch (Exception e) {
            FileLog.e("tmessages", e);
            textView.setText(LocaleController.getString("PhoneNumberHelp", ir.besteveryeverapp.telegram.R.string.PhoneNumberHelp));
        }
        ...
        textView.setText(LocaleController.getString("PhoneNumberChange", ir.besteveryeverapp.telegram.R.string.PhoneNumberChange));
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage(LocaleController.getString("PhoneNumberAlert", ir.besteveryeverapp.telegram.R.string.PhoneNumberAlert));
