...
public class ManageSpaceActivity extends Activity implements ActionBarLayout.ActionBarLayoutDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(ir.besteveryeverapp.telegram.R.style.Theme_TMessages);
        getWindow().setBackgroundDrawableResource(ir.besteveryeverapp.telegram.R.drawable.transparent);
        ...
        if (AndroidUtilities.isTablet()) {
            ...
            backgroundTablet.setImageResource(ir.besteveryeverapp.telegram.R.drawable.cats);
            ...
            layersActionBarLayout.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.boxshadow);
    ...
    private void updateCurrentConnectionState() {
        ...
        if (currentConnectionState == ConnectionsManager.ConnectionStateWaitingForNetwork) {
            text = LocaleController.getString("WaitingForNetwork", ir.besteveryeverapp.telegram.R.string.WaitingForNetwork);
        } else if (currentConnectionState == ConnectionsManager.ConnectionStateConnecting) {
            text = LocaleController.getString("Connecting", ir.besteveryeverapp.telegram.R.string.Connecting);
        } else if (currentConnectionState == ConnectionsManager.ConnectionStateUpdating) {
            text = LocaleController.getString("Updating", ir.besteveryeverapp.telegram.R.string.Updating);
        }
