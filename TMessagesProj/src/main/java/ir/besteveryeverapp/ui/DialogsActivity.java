...
import ir.besteveryeverapp.telegram.DialogObject;
import ir.besteveryeverapp.telegram.FileLog;
import ir.besteveryeverapp.telegram.ImageLoader;
...
import ir.besteveryeverapp.ui.ActionBar.MenuDrawable;
import ir.besteveryeverapp.ui.ActionBar.Theme;
import ir.besteveryeverapp.ui.Adapters.DialogsAdapter;
import ir.besteveryeverapp.ui.Adapters.DialogsSearchAdapter;
import ir.besteveryeverapp.ui.Cells.DialogCell;
import ir.besteveryeverapp.ui.Cells.HintDialogCell;
import ir.besteveryeverapp.ui.Cells.ProfileSearchCell;
import ir.besteveryeverapp.ui.Cells.UserCell;
import ir.besteveryeverapp.ui.Components.EmptyTextProgressView;
...
public class DialogsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        if (!onlySelect && searchString == null) {
            passcodeItem = menu.addItem(1, ir.besteveryeverapp.telegram.R.drawable.lock_close);
            updatePasscodeButton();
        }
        final ActionBarMenuItem item = menu.addItem(0, ir.besteveryeverapp.telegram.R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
            @Override
        ...
        item.getSearchField().setHint(LocaleController.getString("Search", ir.besteveryeverapp.telegram.R.string.Search));
        menu.addItem(5, ir.besteveryeverapp.telegram.R.drawable.ab_ghost).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (ge){
                    menu.getItem(5).setIcon(ir.besteveryeverapp.telegram.R.drawable.a_ghost);
                    Toast.makeText(getParentActivity().getApplicationContext(), ir.besteveryeverapp.telegram.R.string.ghost_e ,Toast.LENGTH_SHORT).show();
                }else {
                    menu.getItem(5).setIcon(ir.besteveryeverapp.telegram.R.drawable.ab_ghost);
                    Toast.makeText(getParentActivity().getApplicationContext(), ir.besteveryeverapp.telegram.R.string.ghost_d ,Toast.LENGTH_SHORT).show();
                }
            }
        });
        SharedPreferences preferences=context.getSharedPreferences("mainconfig", Context.MODE_PRIVATE);
        ...
        if (onlySelect) {
            ...
            actionBar.setTitle(LocaleController.getString("SelectChat", ir.besteveryeverapp.telegram.R.string.SelectChat));
        } else {
            if (searchString != null) {
                actionBar.setBackButtonImage(ir.besteveryeverapp.telegram.R.drawable.ic_ab_back);
            } else {
            ...
            if (BuildVars.DEBUG_VERSION) {
                actionBar.setTitle(LocaleController.getString("AppNameBeta", ir.besteveryeverapp.telegram.R.string.AppNameBeta));
            } else {
                actionBar.setTitle(LocaleController.getString("AppName", ir.besteveryeverapp.telegram.R.string.AppName));
            }
        }
            ...
            public boolean onItemClick(View view, int position) {
                ...
                if (DialogObject.isChannel(dialog)) {
                    ...
                    if (chat != null && chat.megagroup) {
                        items = new CharSequence[]{LocaleController.getString("ClearHistoryCache", ir.besteveryeverapp.telegram.R.string.ClearHistoryCache), chat == null || !chat.creator ? LocaleController.getString("LeaveMegaMenu", ir.besteveryeverapp.telegram.R.string.LeaveMegaMenu) : LocaleController.getString("DeleteMegaMenu", ir.besteveryeverapp.telegram.R.string.DeleteMegaMenu)};
                    } else {
                        items = new CharSequence[]{LocaleController.getString("ClearHistoryCache", ir.besteveryeverapp.telegram.R.string.ClearHistoryCache), chat == null || !chat.creator ? LocaleController.getString("LeaveChannelMenu", ir.besteveryeverapp.telegram.R.string.LeaveChannelMenu) : LocaleController.getString("ChannelDeleteMenu", ir.besteveryeverapp.telegram.R.string.ChannelDeleteMenu)};
                    }
                    builder.setItems(items, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, final int which) {
                            ...
                            if (which == 0) {
                                if (chat != null && chat.megagroup) {
                                    builder.setMessage(LocaleController.getString("AreYouSureClearHistorySuper", ir.besteveryeverapp.telegram.R.string.AreYouSureClearHistorySuper));
                                } else {
                                    builder.setMessage(LocaleController.getString("AreYouSureClearHistoryChannel", ir.besteveryeverapp.telegram.R.string.AreYouSureClearHistoryChannel));
                                }
                                ...
                                if (chat != null && chat.megagroup) {
                                    if (!chat.creator) {
                                        builder.setMessage(LocaleController.getString("MegaLeaveAlert", ir.besteveryeverapp.telegram.R.string.MegaLeaveAlert));
                                    } else {
                                        builder.setMessage(LocaleController.getString("MegaDeleteAlert", ir.besteveryeverapp.telegram.R.string.MegaDeleteAlert));
                                    }
                                } else {
                                    if (chat == null || !chat.creator) {
                                        builder.setMessage(LocaleController.getString("ChannelLeaveAlert", ir.besteveryeverapp.telegram.R.string.ChannelLeaveAlert));
                                    } else {
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.getString("ClearHistory", ir.besteveryeverapp.telegram.R.string.ClearHistory),
                            isChat ? LocaleController.getString("DeleteChat", ir.besteveryeverapp.telegram.R.string.DeleteChat) :
                                    isBot ? LocaleController.getString("DeleteAndStop", ir.besteveryeverapp.telegram.R.string.DeleteAndStop) : LocaleController.getString("Delete", ir.besteveryeverapp.telegram.R.string.Delete)}, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, final int which) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                            builder.setTitle(LocaleController.getString("AppName", ir.besteveryeverapp.telegram.R.string.AppName));
        ...
        searchEmptyView.setText(LocaleController.getString("NoResult", ir.besteveryeverapp.telegram.R.string.NoResult));
        ...
        textView.setText(LocaleController.getString("NoChats", ir.besteveryeverapp.telegram.R.string.NoChats));
        ...
        String help = LocaleController.getString("NoChatsHelp", ir.besteveryeverapp.telegram.R.string.NoChatsHelp);
...
*/
        ...
        dialogsSearchAdapter.setDelegate(new DialogsSearchAdapter.DialogsSearchAdapterDelegate() {
            ...
            public void needRemoveHint(final int did) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setTitle(LocaleController.getString("AppName", ir.besteveryeverapp.telegram.R.string.AppName));
                builder.setMessage(LocaleController.formatString("ChatHintsDelete", ir.besteveryeverapp.telegram.R.string.ChatHintsDelete, ContactsController.formatName(user.first_name, user.last_name)));
                builder.setPositiveButton(LocaleController.getString("OK", ir.besteveryeverapp.telegram.R.string.OK), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (activity != null) {
                ...
                if (activity.checkSelfPermission(Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED || activity.checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    if (activity.shouldShowRequestPermissionRationale(Manifest.permission.READ_CONTACTS)) {
                        ...
                        builder.setTitle(LocaleController.getString("AppName", ir.besteveryeverapp.telegram.R.string.AppName));
                        builder.setMessage(LocaleController.getString("PermissionContacts", ir.besteveryeverapp.telegram.R.string.PermissionContacts));
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
                        builder.setTitle(LocaleController.getString("AppName", ir.besteveryeverapp.telegram.R.string.AppName));
                        builder.setMessage(LocaleController.getString("PermissionStorage", ir.besteveryeverapp.telegram.R.string.PermissionStorage));
                        builder.setPositiveButton(LocaleController.getString("OK", ir.besteveryeverapp.telegram.R.string.OK), null);
                        showDialog(permissionDialog = builder.create());
                    } else {
                        askForPermissons();
    ...
    private void updatePasscodeButton() {
        ...
        if (UserConfig.passcodeHash.length() != 0 && !searching) {
            ...
            if (UserConfig.appLocked) {
                passcodeItem.setIcon(ir.besteveryeverapp.telegram.R.drawable.lock_close);
            } else {
                passcodeItem.setIcon(ir.besteveryeverapp.telegram.R.drawable.lock_open);
            }
        } else {
    ...
    private void didSelectResult(final long dialog_id, boolean useAlert, final boolean param) {
        if (addToGroupAlertString == null) {
            if ((int) dialog_id < 0 && ChatObject.isChannel(-(int) dialog_id) && !ChatObject.isCanWriteToChannel(-(int) dialog_id)) {
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setTitle(LocaleController.getString("AppName", ir.besteveryeverapp.telegram.R.string.AppName));
                builder.setMessage(LocaleController.getString("ChannelCantSendMessage", ir.besteveryeverapp.telegram.R.string.ChannelCantSendMessage));
                builder.setNegativeButton(LocaleController.getString("OK", ir.besteveryeverapp.telegram.R.string.OK), null);
                showDialog(builder.create());
                return;
            }
        }
