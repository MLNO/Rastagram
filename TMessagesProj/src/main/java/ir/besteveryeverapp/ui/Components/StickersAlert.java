...
import ir.besteveryeverapp.ui.Cells.StickerEmojiCell;
import ir.besteveryeverapp.ui.StickerPreviewViewer;
...
public class StickersAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public StickersAlert(Context context, TLRPC.InputStickerSet set, TLRPC.TL_messages_stickerSet loadedSet, StickersAlertDelegate stickersAlertDelegate) {
        ...
        shadowDrawable = context.getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.sheet_shadow);
        ...
        shadow[0].setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.header_shadow);
        ...
        shadow[1].setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.header_shadow_reverse);
        ...
        pickerBottomLayout.cancelButton.setText(LocaleController.getString("Close", ir.besteveryeverapp.telegram.R.string.Close).toUpperCase());
        ...
        pickerBottomLayout.doneButtonBadgeTextView.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.stickercounter);
        ...
        closeButton.setImageResource(ir.besteveryeverapp.telegram.R.drawable.delete_reply);
        ...
        previewSendButton.setText(LocaleController.getString("Close", ir.besteveryeverapp.telegram.R.string.Close).toUpperCase());
        ...
        previewSendButtonShadow.setBackgroundResource(ir.besteveryeverapp.telegram.R.drawable.header_shadow_reverse);
        ...
        if (delegate != null) {
            previewSendButton.setText(LocaleController.getString("SendSticker", ir.besteveryeverapp.telegram.R.string.SendSticker).toUpperCase());
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (error == null) {
                                ...
                                Toast.makeText(getContext(), LocaleController.getString("AddStickersNotFound", ir.besteveryeverapp.telegram.R.string.AddStickersNotFound), Toast.LENGTH_SHORT).show();
                                dismiss();
                            }
                        }
                    });
    ...
    private void updateFields() {
        ...
        if (stickerSet != null) {
            ...
            if (stickerSet.set == null || !StickersQuery.isStickerPackInstalled(stickerSet.set.id)) {
                            ...
                            public void run(TLObject response, final TLRPC.TL_error error) {
                                AndroidUtilities.runOnUIThread(new Runnable() {
                                    ...
                                    public void run() {
                                        try {
                                            if (error == null) {
                                                Toast.makeText(getContext(), LocaleController.getString("AddStickersInstalled", ir.besteveryeverapp.telegram.R.string.AddStickersInstalled), Toast.LENGTH_SHORT).show();
                                            } else {
                                                if (error.text.equals("STICKERSETS_TOO_MUCH")) {
                                                    Toast.makeText(getContext(), LocaleController.getString("TooMuchStickersets", ir.besteveryeverapp.telegram.R.string.TooMuchStickersets), Toast.LENGTH_SHORT).show();
                                                } else {
                                                    Toast.makeText(getContext(), LocaleController.getString("ErrorOccurred", ir.besteveryeverapp.telegram.R.string.ErrorOccurred), Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        } catch (Exception e) {
                ...
                }, LocaleController.getString("AddStickers", ir.besteveryeverapp.telegram.R.string.AddStickers), Theme.STICKERS_SHEET_ADD_TEXT_COLOR, true);
            } else {
                if (stickerSet.set.official) {
                    ...
                    }, LocaleController.getString("StickersRemove", ir.besteveryeverapp.telegram.R.string.StickersRemove), Theme.STICKERS_SHEET_REMOVE_TEXT_COLOR, false);
                }
            }
            adapter.notifyDataSetChanged();
        } else {
