...
import ir.besteveryeverapp.telegram.DispatchQueue;
...
import ir.besteveryeverapp.ui.Cells.PhotoEditToolCell;
...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        cancelTextView.setText(LocaleController.getString("Cancel", ir.besteveryeverapp.telegram.R.string.Cancel).toUpperCase());
        ...
        doneTextView.setText(LocaleController.getString("Done", ir.besteveryeverapp.telegram.R.string.Done).toUpperCase());
        ...
        recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (position == enhanceTool) {
                    ...
                    paramTextView.setText(LocaleController.getString("Enhance", ir.besteveryeverapp.telegram.R.string.Enhance));
                } else if (position == highlightsTool) {
                    previousValue = highlightsValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Highlights", ir.besteveryeverapp.telegram.R.string.Highlights));
                } else if (position == contrastTool) {
                    previousValue = contrastValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Contrast", ir.besteveryeverapp.telegram.R.string.Contrast));
                } else if (position == exposureTool) {
                    previousValue = exposureValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Exposure", ir.besteveryeverapp.telegram.R.string.Exposure));
                } else if (position == warmthTool) {
                    previousValue = warmthValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Warmth", ir.besteveryeverapp.telegram.R.string.Warmth));
                } else if (position == saturationTool) {
                    previousValue = saturationValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Saturation", ir.besteveryeverapp.telegram.R.string.Saturation));
                } else if (position == vignetteTool) {
                    previousValue = vignetteValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Vignette", ir.besteveryeverapp.telegram.R.string.Vignette));
                } else if (position == shadowsTool) {
                    previousValue = shadowsValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Shadows", ir.besteveryeverapp.telegram.R.string.Shadows));
                } else if (position == grainTool) {
                    previousValue = grainValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Grain", ir.besteveryeverapp.telegram.R.string.Grain));
                } else if (position == fadeTool) {
                    previousValue = fadeValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Fade", ir.besteveryeverapp.telegram.R.string.Fade));
                } else if (position == sharpenTool) {
                    previousValue = sharpenValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Sharpen", ir.besteveryeverapp.telegram.R.string.Sharpen));
        ...
        imageView.setImageResource(ir.besteveryeverapp.telegram.R.drawable.edit_cancel);
        ...
        imageView.setImageResource(ir.besteveryeverapp.telegram.R.drawable.edit_doneblue);
        imageView.setBackgroundDrawable(Theme.createBarSelectorDrawable(Theme.ACTION_BAR_PICKER_SELECTOR_COLOR, false));
        ...
        for (int a = 0; a < 4; a++) {
            ...
            if (a == 0) {
                curveTextView[a].setText(LocaleController.getString("CurvesAll", ir.besteveryeverapp.telegram.R.string.CurvesAll).toUpperCase());
            } else if (a == 1) {
                curveTextView[a].setText(LocaleController.getString("CurvesRed", ir.besteveryeverapp.telegram.R.string.CurvesRed).toUpperCase());
            } else if (a == 2) {
                curveTextView[a].setText(LocaleController.getString("CurvesGreen", ir.besteveryeverapp.telegram.R.string.CurvesGreen).toUpperCase());
            } else if (a == 3) {
                curveTextView[a].setText(LocaleController.getString("CurvesBlue", ir.besteveryeverapp.telegram.R.string.CurvesBlue).toUpperCase());
            }
        ...
        tintShadowsButton.setText(LocaleController.getString("TintShadows", ir.besteveryeverapp.telegram.R.string.TintShadows).toUpperCase());
        ...
        tintHighlightsButton.setText(LocaleController.getString("TintHighlights", ir.besteveryeverapp.telegram.R.string.TintHighlights).toUpperCase());
        ...
        blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, ir.besteveryeverapp.telegram.R.drawable.blur_off_active, 0, 0);
        ...
        blurOffButton.setText(LocaleController.getString("BlurOff", ir.besteveryeverapp.telegram.R.string.BlurOff));
        ...
        blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, ir.besteveryeverapp.telegram.R.drawable.blur_radial, 0, 0);
        ...
        blurRadialButton.setText(LocaleController.getString("BlurRadial", ir.besteveryeverapp.telegram.R.string.BlurRadial));
        ...
        blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, ir.besteveryeverapp.telegram.R.drawable.blur_linear, 0, 0);
        ...
        blurLinearButton.setText(LocaleController.getString("BlurLinear", ir.besteveryeverapp.telegram.R.string.BlurLinear));
    ...
    private void updateSelectedBlurType() {
        if (blurType == 0) {
            ...
            blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, ir.besteveryeverapp.telegram.R.drawable.blur_off, 0, 0);
            blurOffButton.setTextColor(0xffffffff);
            blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, ir.besteveryeverapp.telegram.R.drawable.blur_radial_active, 0, 0);
            ...
            blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, ir.besteveryeverapp.telegram.R.drawable.blur_radial, 0, 0);
            blurRadialButton.setTextColor(0xffffffff);
            blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, ir.besteveryeverapp.telegram.R.drawable.blur_linear_active, 0, 0);
        ...
        if (editView.getVisibility() == GONE) {
            ...
            if (selectedTool == blurTool || selectedTool == tintTool || selectedTool == curvesTool) {
                ...
                if (selectedTool == blurTool) {
                    infoTextView.setText(LocaleController.getString("Blur", ir.besteveryeverapp.telegram.R.string.Blur));
                    if (blurType != 0) {
                        blurControl.setVisibility(VISIBLE);
                    }
                } else if (selectedTool == curvesTool) {
                    infoTextView.setText(LocaleController.getString("Curves", ir.besteveryeverapp.telegram.R.string.Curves));
                    ...
                    infoTextView.setText(LocaleController.getString("Tint", ir.besteveryeverapp.telegram.R.string.Tint));
                }
    ...
    public class ToolsAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (i == enhanceTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_enhance, LocaleController.getString("Enhance", ir.besteveryeverapp.telegram.R.string.Enhance), enhanceValue);
            } else if (i == highlightsTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_highlights, LocaleController.getString("Highlights", ir.besteveryeverapp.telegram.R.string.Highlights), highlightsValue);
            } else if (i == contrastTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_contrast, LocaleController.getString("Contrast", ir.besteveryeverapp.telegram.R.string.Contrast), contrastValue);
            } else if (i == exposureTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_brightness, LocaleController.getString("Exposure", ir.besteveryeverapp.telegram.R.string.Exposure), exposureValue);
            } else if (i == warmthTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_warmth, LocaleController.getString("Warmth", ir.besteveryeverapp.telegram.R.string.Warmth), warmthValue);
            } else if (i == saturationTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_saturation, LocaleController.getString("Saturation", ir.besteveryeverapp.telegram.R.string.Saturation), saturationValue);
            } else if (i == vignetteTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_vignette, LocaleController.getString("Vignette", ir.besteveryeverapp.telegram.R.string.Vignette), vignetteValue);
            } else if (i == shadowsTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_shadows, LocaleController.getString("Shadows", ir.besteveryeverapp.telegram.R.string.Shadows), shadowsValue);
            } else if (i == grainTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_grain, LocaleController.getString("Grain", ir.besteveryeverapp.telegram.R.string.Grain), grainValue);
            } else if (i == sharpenTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_details, LocaleController.getString("Sharpen", ir.besteveryeverapp.telegram.R.string.Sharpen), sharpenValue);
            } else if (i == tintTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_tint, LocaleController.getString("Tint", ir.besteveryeverapp.telegram.R.string.Tint), tintHighlightsColor != 0 || tintShadowsColor != 0 ? "◆" : "");
            } else if (i == fadeTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_fade, LocaleController.getString("Fade", ir.besteveryeverapp.telegram.R.string.Fade), fadeValue);
            } else if (i == curvesTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_curve, LocaleController.getString("Curves", ir.besteveryeverapp.telegram.R.string.Curves), curvesToolValue.shouldBeSkipped() ? "" : "◆");
            } else if (i == blurTool) {
                String value = "";
                if (blurType == 1) {
                    value = "R";
                ...
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(ir.besteveryeverapp.telegram.R.drawable.tool_blur, LocaleController.getString("Blur", ir.besteveryeverapp.telegram.R.string.Blur), value);
            }
        }
    }
}
