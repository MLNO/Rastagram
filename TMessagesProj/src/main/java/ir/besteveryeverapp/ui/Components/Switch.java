...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context) {
        ...
        mThumbDrawable = context.getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.switch_thumb);
        if (mThumbDrawable != null) {
            mThumbDrawable.setCallback(this);
        }
        mTrackDrawable = context.getResources().getDrawable(ir.besteveryeverapp.telegram.R.drawable.switch_track);
