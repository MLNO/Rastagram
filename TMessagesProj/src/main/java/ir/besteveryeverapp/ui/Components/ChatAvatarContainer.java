...
import ir.besteveryeverapp.ui.ProfileActivity;
            ...
            if (chat != null) {
                ...
                if (ChatObject.isChannel(chat)) {
                    if (info != null && info.participants_count != 0) {
                        ...
                        if (chat.megagroup) {
                            subtitleTextView.setText(LocaleController.getString("Loading", ir.besteveryeverapp.telegram.R.string.Loading).toLowerCase());
                        } else {
                            if ((chat.flags & TLRPC.CHAT_FLAG_IS_PUBLIC) != 0) {
                                subtitleTextView.setText(LocaleController.getString("ChannelPublic", ir.besteveryeverapp.telegram.R.string.ChannelPublic).toLowerCase());
                            } else {
                                subtitleTextView.setText(LocaleController.getString("ChannelPrivate", ir.besteveryeverapp.telegram.R.string.ChannelPrivate).toLowerCase());
                            }
                        }
                    }
                } else {
                    if (ChatObject.isKickedFromChat(chat)) {
                        subtitleTextView.setText(LocaleController.getString("YouWereKicked", ir.besteveryeverapp.telegram.R.string.YouWereKicked));
                    } else if (ChatObject.isLeftFromChat(chat)) {
                        subtitleTextView.setText(LocaleController.getString("YouLeft", ir.besteveryeverapp.telegram.R.string.YouLeft));
                    } else {
                ...
                if (user.id == 333000 || user.id == 777000) {
                    newStatus = LocaleController.getString("ServiceNotifications", ir.besteveryeverapp.telegram.R.string.ServiceNotifications);
                } else if (user.bot) {
                    newStatus = LocaleController.getString("Bot", ir.besteveryeverapp.telegram.R.string.Bot);
                } else {
