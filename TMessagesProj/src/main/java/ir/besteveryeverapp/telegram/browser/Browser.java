...
package ir.besteveryeverapp.telegram.browser;
...
import ir.besteveryeverapp.telegram.ShareBroadcastReceiver;
import ir.besteveryeverapp.telegram.support.customtabs.CustomTabsCallback;
import ir.besteveryeverapp.telegram.support.customtabs.CustomTabsClient;
import ir.besteveryeverapp.telegram.support.customtabs.CustomTabsIntent;
import ir.besteveryeverapp.telegram.support.customtabs.CustomTabsServiceConnection;
import ir.besteveryeverapp.telegram.support.customtabs.CustomTabsSession;
import ir.besteveryeverapp.telegram.support.customtabsclient.shared.CustomTabsHelper;
import ir.besteveryeverapp.telegram.support.customtabsclient.shared.ServiceConnection;
import ir.besteveryeverapp.telegram.support.customtabsclient.shared.ServiceConnectionCallback;
import ir.besteveryeverapp.ui.ActionBar.Theme;
import ir.besteveryeverapp.ui.LaunchActivity;
    ...
    public static void openUrl(Context context, Uri uri, boolean allowCustom) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 15 && allowCustom && MediaController.getInstance().canCustomTabs() && !internalUri) {
                ...
                builder.setActionButton(BitmapFactory.decodeResource(context.getResources(), ir.besteveryeverapp.telegram.R.drawable.abc_ic_menu_share_mtrl_alpha), LocaleController.getString("ShareFile", ir.besteveryeverapp.telegram.R.string.ShareFile), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 0, share, 0), false);
