...
import ir.besteveryeverapp.telegram.audioinfo.AudioInfo;
import ir.besteveryeverapp.ui.LaunchActivity;

public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {

    public static final String NOTIFY_PREVIOUS = "ir.besteveryeverapp.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "ir.besteveryeverapp.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "ir.besteveryeverapp.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "ir.besteveryeverapp.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "ir.besteveryeverapp.android.musicplayer.next";
