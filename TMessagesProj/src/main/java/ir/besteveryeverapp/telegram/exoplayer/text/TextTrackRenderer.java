 ...
 */
package ir.besteveryeverapp.telegram.exoplayer.text;
...
import ir.besteveryeverapp.telegram.exoplayer.ExoPlaybackException;
...
import ir.besteveryeverapp.telegram.exoplayer.SampleSourceTrackRenderer;
import ir.besteveryeverapp.telegram.exoplayer.TrackRenderer;
import ir.besteveryeverapp.telegram.exoplayer.text.subrip.SubripParser;
import ir.besteveryeverapp.telegram.exoplayer.text.ttml.TtmlParser;
import ir.besteveryeverapp.telegram.exoplayer.text.tx3g.Tx3gParser;
import ir.besteveryeverapp.telegram.exoplayer.text.webvtt.WebvttParser;
  ...
  static {
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.besteveryeverapp.telegram.exoplayer.text.webvtt.WebvttParser")
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.besteveryeverapp.telegram.exoplayer.text.ttml.TtmlParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.besteveryeverapp.telegram.exoplayer.text.webvtt.Mp4WebvttParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.besteveryeverapp.telegram.exoplayer.text.subrip.SubripParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.besteveryeverapp.telegram.exoplayer.text.tx3g.Tx3gParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
