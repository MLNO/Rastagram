...
import ir.besteveryeverapp.telegram.exoplayer.extractor.DefaultExtractorInput;
...
public final class InitializationChunk extends Chunk implements ChunkExtractorWrapper.SingleTrackOutput {
  ...
  public InitializationChunk(DataSource dataSource, DataSpec dataSpec, int trigger, Format format,
    ...
    this(dataSource, dataSpec, trigger, format, extractorWrapper, NO_PARENT_ID);
  }
  ...
  public InitializationChunk(DataSource dataSource, DataSpec dataSpec, int trigger, Format format,
    ...
    super(dataSource, dataSpec, TYPE_MEDIA_INITIALIZATION, trigger, format, parentId);
