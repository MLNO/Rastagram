...
import ir.besteveryeverapp.telegram.exoplayer.drm.DrmSessionManager;
...
import ir.besteveryeverapp.telegram.exoplayer.util.TraceUtil;
...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "ir.besteveryeverapp.telegram.exoplayer.MediaCodecTrackRenderer_" + sign + Math.abs(errorCode);
    }
